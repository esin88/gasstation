...
public interface GasStation {
     ...
     * @throws NotEnoughGasException    Should be thrown in case not enough gas of this type can be provided
     *                                  by any single {@link GasPump}.
     * @throws GasTooExpensiveException Should be thrown if gas is not sold at the requested price (or any lower price)
     */
